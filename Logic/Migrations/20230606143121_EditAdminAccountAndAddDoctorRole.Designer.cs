...
namespace Logic.Migrations
{
    ...
    [Migration("20230606143121_EditAdminAccountAndAddDoctorRole")]
    partial class EditAdminAccountAndAddDoctorRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Logic.Models.DoctorSubject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Logic.Models.IdentityModels.User", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Logic.Models.IdentityModels.UserRefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Logic.Models.Doctor", b =>
                {
                    b.HasBaseType("Logic.Models.IdentityModels.User");
            ...
            modelBuilder.Entity("Logic.Models.DoctorSubject", b =>
                {
                    ...
                    b.HasOne("Logic.Models.Subject", "Subject")
                        ...
                        .HasForeignKey("Logic.Models.DoctorSubject", "SubjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Logic.Models.IdentityModels.UserRefreshToken", b =>
                {
                    b.HasOne("Logic.Models.IdentityModels.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Logic.Models.Message", b =>
                {
                    b.HasOne("Logic.Models.IdentityModels.User", "Receiver")
                        .WithMany("MessagesReceived")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Logic.Models.IdentityModels.User", "Sender")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Logic.Models.IdentityModels.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
